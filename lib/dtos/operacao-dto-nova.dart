...
class Ops {
  ...
  Ops.fromJson(Map<String, dynamic> json) {
    ...
    json['objCalculosDeOperacaoDoBackEnd'] != null
        ? new ObjCalculosDeOperacaoDoBackEnd.fromJson(
        json['objCalculosDeOperacaoDoBackEnd'])
        : null;
    objAgenda = json['objAgenda'];
    if (json['vendaList'] != null) {
      vendaList = <VendaList>[];
      json['vendaList'].forEach((v) {
        vendaList!.add(new VendaList.fromJson(v));
      });
    }
